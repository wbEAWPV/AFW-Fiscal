...
merge 1:1 hhid using "$data_out/output_ref"  , keepusing(poor) nogen keep(1 3)
...
gen education_inKind_pc = am_educ_1_pc + am_educ_2_pc + am_educ_3_pc + am_educ_4_pc + am_educ_7_pc
